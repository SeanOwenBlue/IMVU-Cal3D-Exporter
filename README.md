...
- Enable the add-on by ticking the checkbox (if not checked by default).
...
- An experimental "Scaling" feature was added to support pre-export scaling.
- Spring data not included.
